...
class XMLHelper
{
	...
	*
	*********************************************************************/
	public function combine_xml($dom1, $dom2, $dom1_parent, $dom2_node)
	{
		...
		$node = $doc2->getElementsByTagName($dom2_node)->item(0);
		$new_node = $doc1->importNode($node, true);
		
		//TODO: Not working here... if recieve XML string even with checks above.
		//TODO: WHY????!!!!!!!!!!!
		$doc1->getElementsByTagName($dom1_parent)->item(0)->appendChild($new_node);
